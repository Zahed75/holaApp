    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dimension_length', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Length (cm)')),
                ('dimension_width', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Width (cm)')),
                ('dimension_height', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Height (cm)')),
